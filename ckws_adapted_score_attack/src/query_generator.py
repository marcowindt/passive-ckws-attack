...
from ckws_adapted_score_attack.src.common import KeywordExtractor
...
class QueryResultExtractor(KeywordExtractor):
    ...
    def get_fake_queries(self, size=1, hide_nb_files=True) -> Tuple[tf.Tensor, list]:
        ...
        query_arr = tf.gather(self.occ_array, sample_list, axis=1)  # query_arr = self.occ_array[:, sample_list]
